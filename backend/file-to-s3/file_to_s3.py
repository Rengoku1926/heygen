...
@app.cls(
    image=image,
    volumes={
        "/s3-mount": modal.CloudBucketMount("heygen-bucket-1926", secret=s3_secret)
    },
    timeout=600,
    secrets=[s3_secret]
)
...
def main():
    ...
    test_url = "https://public-heygen-bucket-1926.s3.us-east-1.amazonaws.com/voices/4.wav"
    ...
    headers = {
        "Modal-Key": "wk-98SsgwBoVKqfiJcSJpjkv2",
        "Modal-Secret": "ws-ba626v6WM8lxubvtrTFvNy"
    }
